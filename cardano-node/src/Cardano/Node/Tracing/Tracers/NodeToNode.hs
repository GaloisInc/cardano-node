...
instance MetaTrace (AnyMessageAndAgency (STX.TxSubmission2 txid tx)) where
    namespaceFor (AnyMessageAndAgency stok STX.MsgInit {}) =
      Namespace [] ["MsgInit"]
    namespaceFor (AnyMessageAndAgency stok STX.MsgRequestTxs {}) =
      Namespace [] ["RequestTxIds"]
    namespaceFor (AnyMessageAndAgency stok STX.MsgReplyTxs {}) =
      Namespace [] ["ReplyTxIds"]
    namespaceFor (AnyMessageAndAgency stok STX.MsgRequestTxIds {}) =
      Namespace [] ["RequestTxs"]
    namespaceFor (AnyMessageAndAgency stok STX.MsgReplyTxIds {}) =
      Namespace [] ["ReplyTxs"]
    namespaceFor (AnyMessageAndAgency stok STX.MsgDone {}) =
      Namespace [] ["Done"]
